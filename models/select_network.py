...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        from models.network_unetmoex import (
            EncoderConfig,
            MoEConfig,
            AutoencoderConfig,
            Autoencoder,
        ...
        encoder_cfg = EncoderConfig(
            ...
            num_res_blocks=opt_net["num_res_blocks"],  # 4,
            attention_resolutions=opt_net["attention_resolutions"],  # [16, 8],
            dropout=opt_net["dropout"],  # 0.2,
            channel_mult=opt_net["channel_mult"],  # (2, 4, 8),
            conv_resample=opt_net["conv_resample"],  # False,
            dims=2,
            ...
            scale_factor=opt_net["scale"],
            resizer_num_layers=opt_net["resizer_num_layers"],  # 4,
            resizer_avg_pool=opt_net["resizer_avg_pool"],  # False,
            activation=opt_net["activation"],
            rope_theta=opt_net["rope_theta"],  # 10000.0,
            attention_type=opt_net[
                "attention_type"
    ...
    elif net_type == "network_moex":

        from models.moex.network_moex import (
            EncoderConfig,
            MoEConfig,
            AutoencoderConfig,
            Autoencoder,
        ...
        encoder_cfg = EncoderConfig(
            ...
            backbone_cfg=BackboneDinoCfg(
                ...
                backbone_cfg=BackboneResnetCfg(
                    ...
                    use_first_pool=opt_net["use_first_pool"],
                ),
            ),
        )
        decoder_cfg = MoEConfig(
        ...
        from models.network_selfattention_transformer_moe import (
            Autoencoder,
            EncoderConfig,
            MoEConfig,
            BackboneResnetCfg,
...
def define_D(opt):
    ...
    # ----------------------------------------
        ...
        from models.network_discriminator import (
            Discriminator_VGG_128_SN as discriminator,
        )
        ...
        if "Conv" in classname or "Linear" in classname:
            ...
            if m.affine:
                if init_bn_type == "uniform":
                    ...
                    raise NotImplementedError(
                        f"Batch normalization initialization method [{init_bn_type}] is not implemented"
                    )
