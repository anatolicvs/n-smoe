...
# #SBATCH --beeond
# cp -r /tmp/pb035507/login18-g-2_126567/Medical/mri $BEEOND
# cd $BEEOND/mri
...
apptainer exec --nv --bind $TEMP,$WORK,$HPCWORK,$HOME $HOME/cuda_latest.sif python -u $PWD/main_train_gan.py --opt=$OPTION_PATH
EOT
