...
data_dir = r"/mnt/d/dataset/LabPicsV1//"  # Path to dataset (LabPics 1)
...
sam2_checkpoint = "/home/ozkan/segment-anything-2/checkpoints/sam2_hiera_large.pt"  # path to model weight (pre model loaded from: https://dl.fbaipublicfiles.com/segment_anything_2/072824/sam2_hiera_small.pt)
