...
def update_options_with_beeond(options_path, beeond_dir=None):
    ...
    if beeond_dir:
        ...
        options["datasets"]["train"]["dataroot_H"] = os.path.join(
            beeond_dir, os.path.basename(options["datasets"]["train"]["dataroot_H"])
        )
        options["datasets"]["test"]["dataroot_H"] = os.path.join(
            beeond_dir, os.path.basename(options["datasets"]["test"]["dataroot_H"])
        )
